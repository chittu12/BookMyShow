...
public class BookingController {
	...
	public ResponseEntity<List<Booking>> findAll()
	{
		...
		Long userId = userDetails.getId(); // ✅ direct ID

		
List<Booking> findByUserId = bookingRepository.findByUserId(userId);
		
		return new ResponseEntity<List<Booking>>(findByUserId,HttpStatus.OK);
	}
